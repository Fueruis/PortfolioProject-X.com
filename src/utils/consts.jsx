export const mainMenu = [
  ...
  },
  {
    ...
    icon: {
      active: (
        <svg viewBox="0 0 42 42" className="fill-white w-[26.25px] h-[26.25px]">
          <path
            clip-rule="evenodd"
      ...
      passive: (
        <svg viewBox="0 0 33 32" className="fill-white w-[26.25px] h-[26.25px]">
  ...
  },
  {
    ...
    icon: {
      active: (
        <svg
          viewBox="0 0 24 24"
          className="fill-lime-500 w-[26.25px] h-[26.25px]"
        >
